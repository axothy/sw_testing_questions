# Тестирование ПО билеты

<!--Writerside adds this topic when you create a new documentation project.
You can use it as a sandbox to play with Writerside features, and remove it from the TOC when you don't need it anymore.-->

## 1. Качество ПО. Стандарты качества
...
## 2. Характеристики качества ПО. Функциональная пригодность. Надежность
...
## 3. Характеристики качества ПО. Уровень производительности. Удобство использования
...
## 4. Характеристики качества ПО. Совместимость. Защищенность
...
## 5. Характеристики качества ПО. Сопровождаемость. Переносимость
...
## 6. Методы обеспечения качества существующего ПО
...
## 7. Тестирование ПО. Классификации методов тестирования
...
## 8. Процесс тестирования ПО. Тестирование черного ящика
...
## 9. Процесс тестирования ПО. Тестирование белого ящика (структурное тестирование)
## + 10. Явные и неявные входные данные
...
## 11. Тестовые данные. Классы эквивалентности и анализ граничных данных
...
## 12. Качество набора тестов. Характеристики качества тестов
...
## 13. Тестовое покрытие. Покрытие требований
...
## 14. Тестовое покрытие. Покрытие операторов. Покрытие ветвлений. Покрытие условий
...
## 15. Тестовое покрытие. Покрытие ветвлений и условий программы. MC/DC.
...
## 16. Тестовое покрытие. Полное покрытие условии. Покрытие путей
...
## 17. Тестовое покрытие. Покрытие потока данных
...
## 18. Тестовое покрытие. Мутационное тестирование
...
как? можно вначале присвоить значение не равное нулю, можно возвращать не сумму, что угодно короче
и есть правило преобразования которые гарантируют что программа перестанет быть семантически эквивалентной
эти трансформации позволяют программе сломаться
...
## 19. Проблема наблюдаемости. Проверка утверждений
...
статистка выше показывает на 500к строк кода 7к утверждений, они помогли найти 430 ошибок в по

## 20. Проблема наблюдаемости. Журналирование
...
## 21. Тестовые оракулы. Свойства тестовых оракулов. Виды оракулов
...
## 22. Тестовые оракулы. Генерация оракулов
...
## 24. Интеграционное тестирование. Нисходящее и восходящее интеграционное тестирование
...
## 25. Тестовые двойники. Классификация и общие принципы
...
## 26. Тестовые двойники. Фиктивные объекты, заглушки и поддельные объекты
...
## 27. Тестовые двойники. Шпионы и макеты. Сравнение тестовых двойников
...
## 29. Влияние изменений на качество ПО. Регресс программного обеспечения.
...
## 30. Регрессионное тестирование ПО. Общие принципы. Проблема выбора набора тестов.
...
## 31. Выборочное регрессионное тестирование ПО. Способы идентификации измененных частей программы
...
## 32. Выборочное регрессионное тестирование ПО. Карты покрытия
...
## 33. Регрессионное тестирование ПО. Управление набором регрессионных тестов
...
## 34. Регрессионное тестирование ПО. Приоритизация регрессионных тестов
...
## 35. Нефункциональное тестирование. Тестирование производительности
...
## XX. Пропущено: нагрузочное тестирование, стресс тестирование
...
## 36. Нефункциональное тестирование. Тестирование надежности. Тестирование отказоустойчивости. Тестирование восстановления
...
## 37. Нефункциональное тестирование. Тестирование совместимости. Тестирование сосуществования. Тестирование интероперабельности. Тестирование безопасности. Тестирование удобства использования
...
## 38. Генерация тестов. Общие принципы. Направленная генерация тестов
...
## 39. Символьное исполнение для генерации тестов. Представление программы в форме SSA
...
## 40. Символьное исполнение программ. Формирование трасс
...
## 41. Символьное исполнение. SMT-решатели
...
## 42. Символьное исполнение для генерации тестов. Проблемы символьного исполнения
